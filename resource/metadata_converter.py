...
if __name__ == '__main__':
    ...
    add_link("resource/chicago_1m_zipcode/tbl_attrs_chicago_1m.json", 'resource/chicago_1m_zipcode/chicago_open_data_linked.json', "resource/chicago_1m_zipcode/tbl_attrs_chicago_1m_final.json")
